...
public class TimetableXmlParser {
    ...
    private List readTimetable(XmlPullParser parser) throws XmlPullParserException, IOException {
    ...
    private TimetableEntry readEntry(XmlPullParser parser) throws XmlPullParserException, IOException {
        ...
        return null;//new TimetableEntry(title, summary, link);
    }
